...
public class MainActivity extends AppCompatActivity {
    ...
    private int mBackgroundImagedIndex = 0;
    ...
    private void changeBackground(long time, boolean force) {
        ...
        if (mBackGroundImageList.size() > 0) {
            if (force || time % CHANGE_INTERVAL  == 0) {
                mRootLayout.setBackgroundResource(mBackGroundImageList.get(mBackgroundImagedIndex % mBackGroundImageList.size()));
                mBackgroundImagedIndex++;
            }
        }
    }
